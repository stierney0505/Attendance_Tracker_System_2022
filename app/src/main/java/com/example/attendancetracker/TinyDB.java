...
/*
 * This class simplifies calls to store items on the device
 * TinyDB will hold the list of semesters and sections and
 * will persist past the closing of the app process.
 */
public class TinyDB {
